...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $message1 = "Do you want to be a first guarantor renew?"; // Message for the first guarantor
    $message2 = "Do you want to be a second guarantor renew?"; // Message for the second guarantor
...
" href="loan.php">Back</a> </button>
    <div class="container mt-5">
        <div class="error_handel">
            <h5 class="text-center text-success "><?php echo $success; ?></h5>
            <h3 class="text-center text-danger" style="font-size: 1.2rem; color:red"><?php echo $mssg; ?></h3>
        </div>

        <?php if ($eligible): ?>
            <form id="form" class="form" name="employeeForm" action="" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
                <h1 class="text-center" style="margin-right:8rem">Renew loan</h1><br>
